...
@Component({
  selector: 'app-dragable-test',
  templateUrl: './dragable-test.component.html',
  styleUrls: ['./dragable-test.component.scss'],
})
export class DragableTestComponent  implements AfterViewInit {
